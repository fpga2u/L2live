...
public slots:
    void refresh(const struct S4::NW::L2Stats_t &stats)
    {
        ...
        data[std::pair<int, int>(r++, 1)] = ((long long)stats.recv_fund_snap_cnt);
        data[std::pair<int, int>(r++, 1)] = ((long long)stats.recv_option_snap_cnt);
        ...
        data[std::pair<int, int>(r++, 1)] = ((long long)stats.live_fund_snap_cnt);
        data[std::pair<int, int>(r++, 1)] = ((long long)stats.live_option_snap_cnt);
...
private:
    virtual void initNames() override
    {
        ...
        _row_names.push_back(QStringLiteral("股票快照"));
        _row_names.push_back(QStringLiteral("基金快照"));
        _row_names.push_back(QStringLiteral("期权快照"));
        ...
        _row_names.push_back(QStringLiteral("关注标的股票快照"));
        _row_names.push_back(QStringLiteral("关注标的基金快照"));
        _row_names.push_back(QStringLiteral("关注标的期权快照"));
